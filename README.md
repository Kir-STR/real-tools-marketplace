...
**Skill Guide:** [plugins/real-tools/skills/supervisor/README.md](./plugins/real-tools/skills/supervisor/README.md)
...
/plugin marketplace add Kir-STR/real-tools-marketplace

# Install a specific plugin
/plugin install real-tools@real-tools-marketplace
...
```json
{
  "extraKnownMarketplaces": {
    "real-tools-marketplace": {
      "source": {
        "source": "github",
        "repo": "Kir-STR/real-tools-marketplace"
      }
    }
  }
}
